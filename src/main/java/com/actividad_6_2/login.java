...
public class login {
    ...
    /**
     * Ejercicio 6.2 - Modificación que simula la restriccion de permisos en C:/datos
     *
     * @param nomFichero nombre del fichero
     */
    public static void mostrarFichero(String nomFichero) {
        final String rutaBase = "C:/datos/";

        // Se simula la restriccion de permisos asignandolo solo a C:/datos
        // System.setSecurityManager(newSecurityManager());

        if (!nomFichero.startsWith(rutaBase)) {
            System.out.println("Acceso denegado. Solo se permite leer archivos de C:/datos");
            logger.warning("Intento de acceso fuera de C:/datos: " + nomFichero);
            return;
        }
